...
-(void)loadWebRequest:(BOOL) currentMonth{
    ...
    if(currentMonth){
        targetURL =[NSURL URLWithString:[NSString stringWithFormat:@"http://locationsmagazine.com/Rank/RANKLI%@.html", [Functions getMonthYear:self]]];
    }else{
        targetURL =[NSURL URLWithString:[NSString stringWithFormat:@"http://locationsmagazine.com/Rank/RANKLI%@.html", [Functions getPreviousMonthCurrentYear:self]]];
    }
...
-(void) sendContactEmail{
    ...
    [picker setSubject:[NSString stringWithFormat:@"Long Island Site Ranked #1"]];
