...
@implementation NYSDetailViewController
@synthesize rankView;
...
-(void)loadWebRequest:(BOOL) currentMonth{
    ...
    if(currentMonth){
        targetURL =[NSURL URLWithString:[NSString stringWithFormat:@"http://locationsmagazine.com/Rank/RANKNYS%@.html", [Functions getMonthYear:self]]];
    }else{
        targetURL =[NSURL URLWithString:[NSString stringWithFormat:@"http://locationsmagazine.com/Rank/RANKNYS%@.html", [Functions getPreviousMonthCurrentYear:self]]];
    }
...
-(void) sendContactEmail{
    ...
    [picker setSubject:[NSString stringWithFormat:@"NYS Site Ranked #1"]];
