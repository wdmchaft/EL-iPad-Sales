...
-(void)loadWebRequest:(BOOL) currentMonth{
    ...
    if(currentMonth){
        targetURL =[NSURL URLWithString:[NSString stringWithFormat:@"http://locationsmagazine.com/Rank/RANKHM%@.html", [Functions getMonthYear:self]]];
    }else{
        targetURL =[NSURL URLWithString:[NSString stringWithFormat:@"http://locationsmagazine.com/Rank/RANKHM%@.html", [Functions getPreviousMonthCurrentYear:self]]];
    }
